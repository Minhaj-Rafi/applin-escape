...
def flying_bird(size=68,phase=0):
    ...
    d.ellipse(s,(221,231,220),(28,32,19,24))
    d.polygon(s,(70,141,186),[(32,10),(41,2),(40,14),(49,8),(43,24)])
    d.polygon(s,(239,189,80),[(21,22),(1,27),(3,32),(23,29)])
    d.line(s,(161,113,52),(3,29),(22,27),1)
    d.circle(s,(244,238,203),(26,20),4); d.circle(s,(25,44,48),(25,20),2)
    d.polygon(s,(84,154,195),[(48,43),(69,21-wing),(96,12-wing),(76,46)])
    for offset in (0,6,12):
        d.line(s,(45,112,163),(58+offset,40),(82+offset,18-wing+offset//3),2)
